...
if [[ $1 == 'add' ]]; then
	...
	iptables -t filter -A INPUT -s $2 -j LOG --log-prefix		'[INPUT      ]: '
	iptables -t filter -A OUTPUT -s $2 -j LOG --log-prefix		'[OUTPUT     ]: '
	iptables -t filter -A FORWARD -s $2 -j LOG --log-prefix		'[FORWARD    ]: '
	iptables -t nat -A PREROUTING -s $2 -j LOG --log-prefix		'[PREROUTING ]: '
	iptables -t nat -A POSTROUTING -s $2 -j LOG --log-prefix	'[POSTROUTING]: '
else 
	...
	iptables -t filter -D INPUT -s $2 -j LOG --log-prefix		'[INPUT      ]: '
	iptables -t filter -D OUTPUT -s $2 -j LOG --log-prefix		'[OUTPUT     ]: '
	iptables -t filter -D FORWARD -s $2 -j LOG --log-prefix		'[FORWARD    ]: '
	iptables -t nat -D PREROUTING -s $2 -j LOG --log-prefix		'[PREROUTING ]: '
	iptables -t nat -D POSTROUTING -s $2 -j LOG --log-prefix	'[POSTROUTING]: '
fi
